...
void LT_Setup(){
	...
	Read_Setup();
	if (LT_DETECTED_CARD){
		printf("\nOpenGenshin / Genshin Impact for DOS systems\n");
		printf("Original author: miHoYo Corp.\n");
		printf("A fan-made version by Team NFML.\n");
		printf("https://github.com/octsl/opengenshin\n\n");
		printf("Version: ALPHA_DOS1.0.0-C220307-BUILD15\n\n");
		printf("Press a key to continue...");
		//printf("Select your video card: \n\n0 = EGA, 16 col\n1 = VGA, 256 col");
		while (!kbhit());
		character = getch() - 48;
